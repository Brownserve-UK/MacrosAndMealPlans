...
export type ConsumptionEntry = components['schemas']['ConsumptionEntryDto'];
export type ConsumptionDay = components['schemas']['ConsumptionDayDto'];
...
export type CookingItem = components['schemas']['CookingItemDto'];
export type CookingItemKind = components['schemas']['CookingItemKindDto'];
...
export type TargetSource = components['schemas']['TargetSourceDto'];
export type BodyProfile = components['schemas']['MemberBodyProfileDto'];
export type Sex = components['schemas']['SexDto'];
export type HabitualActivity = components['schemas']['HabitualActivityDto'];
export type Pace = components['schemas']['PaceDto'];
export type CalorieCalculation = components['schemas']['CalorieCalculationDto'];
export type NutritionPlan = components['schemas']['NutritionPlanDto'];
export type GuidedNutritionPlan = components['schemas']['GuidedNutritionPlanDto'];
export type NutritionPlanRecommendation = components['schemas']['NutritionPlanRecommendationDto'];
export type NutritionEmphasis = components['schemas']['NutritionEmphasisDto'];
export type WeightRecord = components['schemas']['WeightRecordDto'];
export type WeightGoal = components['schemas']['WeightGoalDto'];
export type WeightSummary = components['schemas']['WeightSummaryDto'];
export type WeightPoint = components['schemas']['WeightPointDto'];
export type GoalProjection = components['schemas']['GoalProjectionDto'];
export type WeightObjective = components['schemas']['WeightObjectiveDto'];
export type WeightDisplay = components['schemas']['WeightDisplayDto'];
