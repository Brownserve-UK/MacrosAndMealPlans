...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!(
        ...
        body_profiles_created = report.body_profiles_created,
        calculations_created = report.calculations_created,
        weigh_ins_created = report.weigh_ins_created,
        weight_goals_created = report.weight_goals_created,
        ...
        consumption_entries_created = report.consumption_entries_created,
